...
title('Figure 1: Acc Against Time While Falling Right'); hold on;

subplot(4,1,2);
plot(Times,Gyro); xlabel('Times (s)'); ylabel('Angular Velocity (deg/s)');
title('Figure 2: Angular Velocity Against Time While Falling Right'); hold on;

subplot(4,1,3);
plot(Times,hx,Times,hy,Times,hz); xlabel('Time (s)'); ylabel('Magnetism (deg)');
title('Figure 3: Magnetism Against Time While Falling Right'); hold on;

subplot(4,1,4);
plot(Times,PressurePa); xlabel('Time (s)'); ylabel('Pressure (Pa)');
title('Figure 4: Pressure Against Time While Falling Right'); hold on;